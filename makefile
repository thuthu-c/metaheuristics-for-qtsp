...
OBJS = graph.o graph_generator.o nearest_neighborhood.o cheapest_insertion.o brute_force.o benchmark.o graphio.o memetic.o branch_and_bound.o tabu.o genetic_improved.o random.o tabu_memetic.o hga.o trans_qtsp.o  trans_qtsp_v1.o trans_qtsp_v2.o trans_qtsp_v3.o trans_qtsp_v4.o rcl.o
